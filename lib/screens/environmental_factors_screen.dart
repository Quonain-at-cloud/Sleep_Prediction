  ...
  Future<void> _saveAndContinue() async {
    ...
    try {
      ...
      Map<String, dynamic> minSleepData = {
        ...
        'Stress Level': 1,
        'weekdayBedtimeHour': 1,
        'weekdayBedtimeMinute': 1,
        'weekdayWakeUpHour': 1,
        'weekdayWakeUpMinute': 1,
        'weekendBedtimeHour': 1,
        'weekendBedtimeMinute': 1,
        'weekendWakeUpHour': 1,
        'weekendWakeUpMinute': 1,
        'useElectronicDevicesBeforeBed': false,
        'howRelaxedBeforeSleep': 1,
